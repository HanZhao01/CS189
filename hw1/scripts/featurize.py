...
def freq_now_feature(text, freq):
    return int('now' in text)

def freq_act_feature(text, freq):
    return int('act' in text)

def freq_save_feature(text, freq):
    return int('save' in text)

def freq_deal_feature(text, freq):
    return int('deal' in text)

def freq_expires_feature(text, freq):
    return int('expires' in text)
...
def generate_feature_vector(text, freq):
    ...
    feature.append(freq_act_feature(text, freq))
    feature.append(freq_now_feature(text, freq))
    feature.append(freq_expires_feature(text, freq))
